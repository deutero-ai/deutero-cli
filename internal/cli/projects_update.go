...
func newProjectsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Update a project's name and/or description. Omitted fields are untouched.",
		Example:     "  deutero-pp-cli projects update be8fc6bf-8819-4f73-81f9-961cf751b13a",
		Annotations: map[string]string{"pp:endpoint": "projects.update", "pp:method": "PATCH", "pp:path": "/api/v1/projects/{project_id}", "pp:happy-args": "project_id=be8fc6bf-8819-4f73-81f9-961cf751b13a"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			printErr := printOutputWithFlagsMeta(cmd.OutOrStdout(), data, flags, map[string]any{"source": "live"}, map[string]bool{"id": true, "name": true, "study_count": true})
			if partialFailure != nil && !flags.allowPartialFailure {
				return partialFailureErr(fmt.Errorf("partial failure in %s response: %s", "projects", partialFailure.Message))
			}
			return printErr
