...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"deutero-pp-cli auth login",
		"deutero-pp-cli doctor",
		"deutero-pp-cli help items",
		"deutero-pp-cli sync",
		"deutero-pp-cli profile list",
		"deutero-pp-cli feedback list",
		"deutero-pp-cli which",
		"deutero-pp-cli agent-context",
		"deutero-pp-cli completion bash",
		"deutero-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"deutero-pp-cli recall",
		"deutero-pp-cli learnings",
		"deutero-pp-cli teach-pattern",
		"deutero-pp-cli teach-lookup",
		"deutero-pp-cli items list",
	}
