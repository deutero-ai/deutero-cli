...
func newProjectsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a new project owned by the caller's organization.",
		Example:     "  deutero-pp-cli projects create --name \"Example study\"",
		Annotations: map[string]string{"pp:endpoint": "projects.create", "pp:method": "POST", "pp:path": "/api/v1/projects", "pp:requires-input": "true"},
